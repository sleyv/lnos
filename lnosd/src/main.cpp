                ...
                if (path == "/nodes") {
                    ...
                    content_type = "text/html; charset=utf-8";
                     ...
                     html << "<!DOCTYPE html>\n"
                          ...
                          << "  .btn { background: #21262d; border: 1px solid #30363d; color: #c9d1d9; padding: 6px 16px; border-radius: 6px; cursor: pointer; font-size: 13px; transition: background .15s; }\n"
                          ...
                          << "      <span style=\"color:#484f58;font-size:12px;\">Updated: <span id=\"last-updated\">—</span></span>\n"
                          << "    </div>\n"
                          << "    <table>\n"
