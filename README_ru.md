...
- 🛡️ **Безопасная установка**: Ключи генерируются с правами доступа 0600 (доступ только для владельца), а привилегированные этапы настройки изолированы, предотвращая утечки конфиденциальных данных.
